...
function crearGato(nombre, edad) { //1
...
function eliminarPropiedad(objeto, propiedad) { //5
...
function verificarPassword(usuario, password) { //9 y 10
...
function actualizarPassword(usuario, nuevaPassword) { //11
...
function agregarAmigo(usuario, nuevoAmigo) { //12
...
function pasarUsuarioAPremium(usuarios) { //13
...
function sumarLikesDeUsuario(usuario) { //15
